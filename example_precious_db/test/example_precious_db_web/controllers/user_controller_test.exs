defmodule ExamplePreciousDbWeb.UserControllerTest do
  use ExamplePreciousDbWeb.ConnCase

  alias ExamplePreciousDb.Accounts

  @create_attrs %{age: 42, first_name: "some first_name", last_name: "some last_name"}
