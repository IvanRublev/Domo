defmodule ExampleAvialiaWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use ExampleAvialiaWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import ExampleAvialiaWeb.ConnCase

      alias ExampleAvialiaWeb.Router.Helpers, as: Routes

      # The default endpoint for testing
      @endpoint ExampleAvialiaWeb.Endpoint
    end
  end
