defmodule Benchmark.Samples do
  ...
  def tweet_map do
    StreamData.fixed_map(%{
      created_at: StreamData.string(:alphanumeric, length: 20),
      ...
      id_str: StreamData.string(:alphanumeric, length: 20),
      in_reply_to_screen_name:
        StreamData.one_of([
          StreamData.string(:alphanumeric, length: 20),
      ...
      lang:
        StreamData.one_of([
          StreamData.string(:alphanumeric, length: 3),
          StreamData.member_of([nil])
        ]),
      ...
      source: StreamData.string(:alphanumeric, length: 85),
      text: StreamData.string(:alphanumeric, length: 140),
  ...
  def user_map do
    StreamData.fixed_map(%{
      ...
      description:
        StreamData.one_of([
          StreamData.string(:alphanumeric, length: 112),
          StreamData.member_of([nil])
        ]),
      ...
      location:
        StreamData.one_of([
          StreamData.string(:alphanumeric, length: 15),
          StreamData.member_of([nil])
        ]),
      name: StreamData.string(:alphanumeric, length: 11),
      profile_banner_url: StreamData.string(:alphanumeric, length: 64),
      profile_image_url_https: StreamData.string(:alphanumeric, length: 82),
      protected: StreamData.boolean(),
      screen_name: StreamData.string(:alphanumeric, length: 14),
      statuses_count: StreamData.integer(1..4000),
      url:
        StreamData.one_of([
          StreamData.string(:alphanumeric, length: 25),
          StreamData.member_of([nil])
        ]),
